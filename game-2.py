...
the_pick_up_formerly_known_as_donut_texture = pygame.image.load('krofna-2.png').convert_alpha()      
...
while True: 
    ...
    if game_active:
        ...
        if any(rect.colliderect(player_rect) for rect in colliders) or alternating_bird_rectangle.colliderect(player_rect):
            game_active = False
